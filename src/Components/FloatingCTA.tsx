...
export default function FloatingCTA() {
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 rounded-full border border-neutral-200 bg-white/80 backdrop-blur-md px-5 py-2 shadow-lg cursor-pointer hover:shadow-xl transition-shadow">
